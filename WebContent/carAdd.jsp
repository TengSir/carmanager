 ...
 <div class="rt_content">
      ...
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <input type="text" class="textbox textbox_225" placeholder="品牌名称..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">系列名称：</span>
        <input type="text" class="textbox textbox_225" placeholder="系列名称..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">售价：</span>
        <input type="text" class="textbox textbox_225" placeholder="售价..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">行驶里程：</span>
        <input type="text" class="textbox textbox_225" placeholder="行驶里程..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
        <span class="item_name" style="width:120px;">颜色：</span>
        <input type="text" class="textbox textbox_225" placeholder="颜色..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
        <li>
        <span class="item_name" style="width:120px;">排量：</span>
        <input type="text" class="textbox textbox_225" placeholder="排量..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
       ...
       <li>
        ...
        <input type="email" class="textbox textbox_225"   placeholder="所在地..."/>
        <span class="errorTips">错误提示信息...</span>
       </li>
       <li>
